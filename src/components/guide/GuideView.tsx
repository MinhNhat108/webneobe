...
export const GuideView: React.FC<GuideViewProps> = ({ onSelectSection }) => {
  ...
  const faqList = [
    ...
    },
    {
      ...
      a: 'Vào mục "1. Dự Án & Cụm Bè" ở menu trái, sau đó nhấn nút "Dữ liệu gốc Huổi Vanh" (có biểu tượng làm mới). Phần mềm sẽ nạp lại toàn bộ thông số chuẩn của 13 cụm bè và 299 điểm neo theo đúng hồ sơ thiết kế ban đầu.'
    },
    {
              ...
              <div className="flex items-start justify-between gap-4 border-b border-slate-100 pb-4">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">
                    Khởi tạo hồ sơ công trình và chọn cụm bè trong tổng thể 13 cụm bè Hồ Huổi Vanh
                  </p>
                </div>
                <button
                  type="button"
              ...
              <div className="space-y-4 text-xs text-slate-700 leading-relaxed">
                <div className="p-4 bg-slate-50 rounded-xl border border-slate-200/80 space-y-3">
                  ...
                  <ul className="list-disc pl-5 space-y-2">
                    <li>
                      <strong>Chọn cụm bè (BÈ 1 đến BÈ 13):</strong> Thanh nút bấm trên đầu trang cho phép chuyển đổi tức thì giữa 13 cụm bè. Khi chọn bè nào, toàn bộ kích thước hình học (L x W), số tấm pin, mã cáp và số dây neo của cụm bè đó sẽ được nạp tự động.
                    </li>
                    <li>
            ...
            <div className="card card-pad space-y-5 animate-fade-in">
              <div className="flex items-start justify-between gap-4 border-b border-slate-100 pb-4">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">
                    Trực quan hóa vị trí thực địa của 13 cụm bè và hệ thống cọc neo hồ Huổi Vanh
                  </p>
                </div>
                <button
                  type="button"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs text-slate-700 leading-relaxed">
                <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-2">
                  ...
                  <p className="text-slate-600">
                    Vẽ trực tiếp file DXF lên Canvas. Hỗ trợ đầy đủ phóng to, thu nhỏ, di chuyển bản vẽ mặt bằng bố trí hệ neo 13 bè.
                  </p>
                </div>
